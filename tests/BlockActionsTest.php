...
class BlockActionsTest extends DatabaseTestBase {
    ...
    public function testGetBlockActionResponse() {
        ...
        $this->assertSame(
            '{"id":1,"event_id":1,"block_id":1,"category_id":1,"block":{"id":1,"seatplan_image_data_url":"data_url","name":"Block 1"},"category":{"id":1,"name":"Category 1","price":2,"price_reduced":1},"seats":[{"id":1,"block_id":1,"name":"Seat 1","x0":0,"y0":1,"x1":2,"y1":3,"x2":4,"y2":5,"x3":6,"y3":7}]}',
