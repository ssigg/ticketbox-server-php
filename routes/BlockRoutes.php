 ...
 * 
 */
$app->get('/admin/eventblocks', Actions\ListEventblocksAction::class);

/**
 * 
 */
$app->get('/admin/eventblocks/{id}', Actions\GetEventblockAction::class);

/**
 * 
 */
$app->post('/admin/eventblocks', Actions\CreateEventblockAction::class);

/**
 * 
 */
$app->put('/admin/eventblocks/{id}', Actions\ChangeEventblockAction::class);

/**
 * 
 */
$app->delete('/admin/eventblocks/{id}', Actions\DeleteEventblockAction::class);